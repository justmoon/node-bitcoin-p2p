...
var MAX_TARGET = new Buffer('00000000FFFF0000000000000000000000000000000000000000000000000000', 'hex');
 ...
 */
var decodeDiffBits = exports.decodeDiffBits = function (diffBits) {
	diffBits = parseInt(diffBits);
...
var calcDifficulty = exports.calcDifficulty = function (target) {
	if (!(target instanceof Buffer)) target = decodeDiffBits(target);
