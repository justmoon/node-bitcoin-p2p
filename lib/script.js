...
Script.prototype.simpleOutPubKeyHash = function ()
{
	...
	default:
		winston.info("Encountered non-standard scriptPubKey");
		winston.debug("Strange script was:" + this.toString());
		return null;
	}
};
...
Script.prototype.getInType = function ()
{
	if (this.chunks.length == 1) {
		...
		winston.info("Encountered non-standard scriptSig");
		winston.debug("Strange script was:" + this.toString());
		return null;
	}
};
...
Script.prototype.getStringContent = function ()
{
	var script = '';
